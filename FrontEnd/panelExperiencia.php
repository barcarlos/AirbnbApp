        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto wow fadeInUp">
                    <h3 class="text-center font-weight-bold">Mis<span class="bg-main">Experiencias</span></h3>
            ...
            <div class="row">
                <?php 
                session_start();
                $url = $apiurl2 . "misexperiencias/" . $_SESSION['id'] ; //concat the api url with the uri of the service
                $data=getDataapi($url) ;
