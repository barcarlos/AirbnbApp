          ...
          <ul class="mob-ul">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-link">
                        <a class="btn btn-primary btn-block btn-login" href="panelExperiencia.php">Regresar</a>
                    </li>
                    <li class="nav-link">
    ...
    <header class="masthead text-white ">
        ...
        <div class="row">
                <div class="col-md-8 mx-auto wow fadeInUp">
                    <h3 class="text-center font-weight-bold">Las reservas de tus experiencias<span class="bg-main"> son:</span></h3>
            ...
            session_start();
            $url = $apiurl2 . "reservacionesrecibidas/" . $_SESSION['id']  ; //concat the api url with the uri of the service
            $data=getDataapi($url);
            ?>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="tile">
                        <div class="wrapper">
                            ...
                            <div class="stats">
                                <div>
                                    <strong>Hecha por:</strong> <?php 
                                    $url = $apiurl . "usuario/" . $data[$i]['idnombre']; //concat the api url with the uri of the service
                                    $data2=getDataapi($url);
                                    echo $data2[0]['nombre']; ?>
                                </div>
